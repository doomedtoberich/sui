...
impl CheckpointLagMetricReporter {
    ...
    pub fn new_for_pipeline<P: Processor>(
        ...
        Arc::new(Self {
            checkpoint_time_lag_histogram: checkpoint_time_lag_histogram
                .with_label_values(&[P::NAME]),
            latest_checkpoint_time_lag_gauge: latest_checkpoint_time_lag_gauge
                .with_label_values(&[P::NAME]),
            latest_checkpoint_sequence_number_gauge: latest_checkpoint_sequence_number_gauge
                .with_label_values(&[P::NAME]),
            latest_reported_checkpoint: AtomicU64::new(0),
        })
    }
